...
//        yes = (ImageButton) view.findViewById(R.id.stresstester);
//        no = (ImageButton) view.findViewById(R.id.mindfulness);
//        notsure = (ImageButton) view.findViewById(R.id.report);
//
//
...
//                Intent testintent = new Intent(HomeActivity.this,StressTest.class);
//                startActivity(testintent);
//            }
//        });
